...
/**
 * A composite {@link LogTarget} that encapsulates other log 
 * targets to which it dispatches incoming {@link LogEvent}s.
 * 
 * @author yduchesne
 *
 */
public class CompositeTarget implements LogTarget{
  ...
  /**
   * @param nested a {@link LogTarget} add to this instance.
   */
