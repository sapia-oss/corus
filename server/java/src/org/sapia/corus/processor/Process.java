...
public class Process implements java.io.Serializable {
  ...
  public static final String KILL_REQUESTOR_ADMIN          = "corus.admin";
  public static final String KILL_REQUESTOR_SERVER         = "corus.server";
  public static final String KILL_REQUESTOR_PROCESS        = "corus.process";
  ...
  private List               _activePorts                  = new ArrayList();
   ...
   */
  public synchronized void kill(String requestor) {
    ...
    if (_status == ACTIVE || _status == KILL_REQUESTED) {
      ...
      shutdown.setRequestor(requestor);
