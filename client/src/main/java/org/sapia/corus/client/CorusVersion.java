...
/**
 * An instance of this class is used to load the version number of the Corus installation.
 * The version number is kept in a properties file, in the classpath, under: <code>org/sapia/corus/version.properties</code>.
 *  
 * @author yduchesne
 *
 */
