...
public class FieldDescriptor {
  ...
  /**
   * 
   * @param index the index of this instance in it's parent {@link ClassDescriptor}
   * @param name the name of the field descriptor.
   * @param accessor the accessor {@link Method} of the corresponding field/property.
   * @param mutator the {@link Mutator} of the corresponding field/property.
   */
  FieldDescriptor(
      int index, 
      String name, 
  ...
  public Object invokeAccessor(Object instance) throws FieldAccessException{
    try{
      ...
      throw new FieldAccessException(String.format("Could not access field %s", name), 
