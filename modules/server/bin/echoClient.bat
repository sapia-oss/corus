...
for %%i in (%CORUS_HOME%\server\lib\*.jar) do call %CORUS_HOME%\bin\lcp.bat %%i
...
"%JAVA_HOME%/bin/java" -Dcorus.home="%CORUS_HOME%" org.sapia.corus.examples.EchoClient %1 %2 %3 %4
