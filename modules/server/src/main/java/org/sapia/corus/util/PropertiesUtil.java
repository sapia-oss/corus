...
public class PropertiesUtil {
	...
	/**
	 * @param toFilter the {@link Properties} to filter.
	 * @param filter the {@link PropertiesFilter} to use.
	 * @return a new {@link Properties} instance, which will contain only the properties
	 * that will have been accepted by the given filter.
	 */
	 ...
	 * 
	 * @param from the {@link Properties} to copy form.
	 * @param to the {@link Properties} to copy to.
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * 
	 * @param toTransform  the {@link Properties} to transform.
	 * @param transformer the {@link PropertiesTransformer} to use.
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * 
	 * @param toPopulate the {@link Properties} to populate.
	 * @param toLoad the {@link File} containing the properties.
	 * @throws IOException if an problem occurs trying to load the properties.
	 */
	...
	/**
	 * Populates a {@link Properties} instance from a given file, but only if the file 
	 * exists - returns silently if it doesn't.
	 * 
	 * @param toPopulate the {@link Properties} to populate.
	 * @param toLoad the {@link File} containing the properties.
	 * @throws IOException if an problem occurs trying to load the properties.
	...
	/**
	 * Returns the property values contained in the given {@link Properties} instance. These values
	 * are sorted by their corresponding property name.
	 * 
	 * @param props a {@link Properties} instance.
	 * @return the {@link Collection} of sorted (by name) property values of the given {@link Properties}.
	 */
	@SuppressWarnings("unchecked")
  public static Collection<String> values(Properties props) {
	...
	/**
	 * Returns the sorted {@link Map} containing the given properties (sorting is done
	 * by property name).
	 * 
	 * @param props a {@link Properties} instance.
  ...
  public static Map<String, String> map(Properties props) {
	 ...
	 * 
	 * @param props the {@link Properties} to process.
	 * @param replacement the {@link StrLookup} instance which holds the replacement values.
	 * @return a new {@link Properties} instance, containing the transformed properties.
	 */
	@SuppressWarnings("unchecked")
