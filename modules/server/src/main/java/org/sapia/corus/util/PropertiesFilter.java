...
/**
 * An instance of this interface determines if some properties should be
 * filtered out.
 * 
 * @author yduchesne
 * 
...
public interface PropertiesFilter {
  ...
  /**
   * A {@link PropertiesFilter} that will accept the properties whose name match
   * a given prefix.
   */
  ...
  /**
   * A {@link PropertiesFilter} that will accept the properties whose name
  ...
  public static class NameContainsPropertiesFilter implements PropertiesFilter {
    ...
    /**
     * @param substring
     *          a substring whose containment should be checked.
     * @return a new instance of this class.
     */
  ...
  /**
   * A {@link PropertiesFilter} that negates the outcome of a delegate
