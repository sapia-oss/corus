...
/**
 * This task initiates the execution of a new process, based on a given distribution, 
 * process configuration, and profile. This task creates a new {@link Process} instance
 * corresponding to the OS process to start. If the execution of the process is successful
 * at the OS level, the {@link Process} instance is saved to the Corus server's database.
 * <p>
 * Calls:
 * <ol>
 *  <li> {@link PerformExecProcessTask}: in order to actually start the OS process.
 * </ol>
 *
...
public class ExecTask extends Task<Void, TaskParams<Distribution,ProcessConfig,String,Void>> implements Throttleable{
  ...
  @Override
  public Void execute(TaskExecutionContext ctx, TaskParams<Distribution,ProcessConfig,String,Void> params) 
    throws Throwable {
