...
/**
 * An instance of this class is internally used by a
 * {@link TaskExecutionContextImpl} to route task logging output to the task
 * manager's task log, and to the task's log itself.
 * 
 * @author yduchesne
 * 
 */
public class InternalTaskLog implements TaskLog {
  ...
  /**
   * This constructor internally assigns a {@link NullTaskLog} as the
   * task-specific log.
   * 
   * @param global
   *          the task manager's {@link TaskLog}
   */
