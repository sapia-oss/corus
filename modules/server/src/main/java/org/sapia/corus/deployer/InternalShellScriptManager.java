...
public interface InternalShellScriptManager extends ShellScriptManager {
  ...
  /**
   * Adds the given shell script to this instance. Deletes the existing one (for the
   * given shell script's alias) if any.
   * 
   * @param script the {@link ShellScript} to add.
   * @param file the script's actual {@link File}.
   */
  public ProgressQueue addScript(ShellScript script, File file);
  
  /**
   * @param script a {@link ShellScript} instance.
