...
/**
 * An instance of this class is expected to create the subtasks that are necessary in the
 * context of deploying an artifact (distribution, file, shell script).
 * 
 * @author yduchesne
 *
 */
public abstract class ArtifactDeploymentHandlerTaskHelper {
  ...
  /**
   * @param config the {@link RepositoryConfiguration}.
   * @param context the {@link TaskExecutionContext} in the context of which this instance will be used.
   */
  ...
  /**
   * @return the {@link TaskExecutionContext} of the task in the context of which this instance is used.
   */
   ...
   * 
   * @param tasks a {@link CompositeTask}.
   */
