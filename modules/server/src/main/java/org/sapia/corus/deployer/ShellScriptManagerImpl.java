...
public class ShellScriptManagerImpl extends ModuleHelper implements InternalShellScriptManager {
        ...
        try {
          fileSystem.deleteFile(
              FilePath.newInstance()
                .addDir(deployerConfig.getScriptDir())
                .setRelativeFile(s.getFileName())
                .createFile());
  ...
  @Override
  public ProgressQueue executeScript(String alias)
      throws ScriptNotFoundException, IOException {
