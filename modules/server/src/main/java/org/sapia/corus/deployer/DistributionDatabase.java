...
public interface DistributionDatabase {
   ...
   */
  public void addDistribution(Distribution dist) throws DuplicateDistributionException;
   ...
   * @return <code>true</code> if this instance contains the distribution
  ...
  /**
   * Returns a list of distributions that match the given distribution criteria.
   * 
   * @param criteria
   *          a {@link DistributionCriteria}
  ...
  /**
   * Returns the distribution that matches the given distribution criteria.
   * 
   * @param criteria
   *          a {@link DistributionCriteria}
