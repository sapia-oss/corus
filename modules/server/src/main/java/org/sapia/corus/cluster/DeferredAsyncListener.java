...
/**
 * An instance of this class is used to keep {@link RemoteEvent}s until the Corus server has started.
 *
 * @author yduchesne
 *
 */
class DeferredAsyncListener implements AsyncEventListener, EventChannelStateListener {
  ...
  private Map<String, AsyncEventListenerWrapper> ayncListenersByEventType = 
      new ConcurrentHashMap<String, AsyncEventListenerWrapper>();
   ...
   * @param delegate the {@link AsyncEventListener} to register with this instance.
  ...
  /**
   * 
   * @param listener an {@link EventChannelStateListener} to add to this instance.
   * @return this instance.
   */
  ...
  /**
   * Flushes the events that have been received so far to the appropriate listeners that this instance holds.
   */
