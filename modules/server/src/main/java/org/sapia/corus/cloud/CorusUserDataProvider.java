...
/**
 * Interface specifying the behavior for fetching user data from the cloud.
 * 
 * @author yduchesne
 * 
 */
public interface CorusUserDataProvider {
   ...
   * @throws IOException
   *           if an problem occurs fetching the data.
   * @throws JSONException
   *           if a JSON parsing error occurred.
   */
   ...
   * @param url
   *          a {@link URI}.
   * @return <code>true</code> if this instance can handle the provided
   *         {@link URI}.
   */
