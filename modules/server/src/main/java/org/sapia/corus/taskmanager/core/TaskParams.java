...
/**
 * This class is meant as a convenience for passing in multiple parameters to a
 * {@link Task}.
 * 
 * @author yduchesne
 * 
 * @param <P1>
 *          the generic type of the first param.
 * @param <P2>
 *          the generic type of the second param.
 * @param <P3>
 *          the generic type of the third param.
 * @param <P4>
 *          the generic type of the fourth param.
 * 
