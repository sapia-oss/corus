...
/**
 * A {@link TaskLog} that wraps another one and delegates the method
 * calls to it (EXCEPT FOR THE {@link #close()} METHOD - which does nothing).
 * <p>
 * This task log should be used in the context of executing "children" tasks (a child task's
 * execution is triggered by another task). 
 * 
 * @author yduchesne
 *
 */
