...
public class ForceGetArtifactListTaskTest extends AbstractRepoTaskTest {

  private Set<CorusHost>      emptyHosts, clientHosts, serverHosts;
  private PullProcessState    pullProcessState; 
  private ForceGetArtifactListTask task;
  ...
  public void setUp() {
    ...
    task           = new ForceGetArtifactListTask(OptionalValue.of(client.getEndpoint()), pullProcessState, callback);
   }
