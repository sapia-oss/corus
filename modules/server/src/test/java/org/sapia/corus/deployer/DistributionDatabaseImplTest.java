...
public class DistributionDatabaseImplTest {
  ...
  @Test
  public void testRemoveDistributions_version_number_not_ordered_backup() throws Exception {
    store = new DistributionDatabaseImpl();

    Distribution d1 = new Distribution("test", "1.2");
    d1.setTimestamp(1);
    Distribution d2 = new Distribution("test", "dev");
    d2.setTimestamp(2);
    ...
    Distribution actual = dists.get(0);
