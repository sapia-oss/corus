...
public class EndpointTest {
  ...
  @Before
  public void setUp() {
    ep1 = new Endpoint(new TCPAddress("test", "localhost", 1000), new TCPAddress("test", "localhost", 1001));

    ep2 = new Endpoint(new TCPAddress("test", "localhost", 2000), new TCPAddress("test", "localhost", 2001));
  }
