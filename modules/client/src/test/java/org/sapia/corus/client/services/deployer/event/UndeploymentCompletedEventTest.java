...
public class UndeploymentCompletedEventTest {

  private Distribution               dist;
  private CorusHost                  host;
  private UndeploymentCompletedEvent event;

  @Before
  public void setUp() throws Exception {
    dist  = TestCorusObjects.createDistribution();
    event = new UndeploymentCompletedEvent(dist);
  ...
  public void testToEventLog() {
    ...
    assertThat(log.getType()).isEqualTo(UndeploymentCompletedEvent.class.getSimpleName());
