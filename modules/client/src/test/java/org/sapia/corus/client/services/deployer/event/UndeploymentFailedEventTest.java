...
public class UndeploymentFailedEventTest {

  private Distribution            dist;
  private CorusHost               host;
  private UndeploymentFailedEvent event;

  @Before
  public void setUp() throws Exception {
    dist  = TestCorusObjects.createDistribution();
    event = new UndeploymentFailedEvent(dist);
  ...
  public void testToEventLog() {
    ...
    assertThat(log.getType()).isEqualTo(UndeploymentFailedEvent.class.getSimpleName());
