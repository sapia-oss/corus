...
public class ProcessRestartedEventTest {
  
  private CorusHost             host;
  private Distribution          distribution;
  private ProcessConfig         processConfig;
  private Process               process;
  private ProcessRestartedEvent event;
  ...
  public void setUp() throws Exception {
    ...
    event         = new ProcessRestartedEvent(distribution, processConfig, process);
  }
  ...
  public void testToEventLog() {
    ...
    assertThat(log.getType()).isEqualTo(ProcessRestartedEvent.class.getSimpleName());
