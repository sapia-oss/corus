...
public class ProcessStaleEventTest {
  ...
  public void testToEventLog() {
    ...
    assertThat(log.getType()).isEqualTo(ProcessStaleEvent.class.getSimpleName());
