...
public class ClassDescriptor<T> {
   ...
   * 
   * @param type the persistent class.
   */
  ...
  /**
   * @param name the name of the {@link FieldDescriptor} to return.
  ...
  /**
   * @param index the index of the {@link FieldDescriptor} to return.
  ...
  public T newInstance(){
    try{
      ...
      throw new ConstructorAccessException(
          String.format("Could not create instance of %s", type.getName()), e);
    }
  }
