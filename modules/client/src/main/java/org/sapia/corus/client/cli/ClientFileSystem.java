...
public interface ClientFileSystem {
   ...
   *          a directory name.
   * @throws IOException
   *           if the given directory name does not correspond to a directory.
  ...
  /**
   * Returns the file object corresponding to the given file name. The actual
   * physical resource may or may not exist, it is up to the calling code to
