...
public interface RepositoryConfiguration extends Remote {
  ...
  /**
   * @return <code>true</code> if the repo server should send shell scripts to repo clients (<code>true</code> by default).
   */  
  ...
  /**
   * @return <code>true</code> if the repo client should accept shell scripts from repo servers (<code>true</code> by default).
   */
