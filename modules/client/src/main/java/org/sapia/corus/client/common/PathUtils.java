...
public class PathUtils {
  ...
  /**
   * Appends <code>subPath</code> to <code>path</code>, adding a "/" character in
   * between as a separator, if required.
   * 
   * @param path the path to which to append a sub-path.
   * @param subPath the sub-path to append to the given path.
   ...
   * 
   * @param toConcat the paths to concatenate.
