...
public interface DbModule extends Module {
  ...
  /**
   * Returns a {@link DbMap} instance for the given name.
   ...
   *
   * @param name the logical name of the desired {@link DbMap}.
   * @return a new {@link DbMap} if none exists for the given name,
