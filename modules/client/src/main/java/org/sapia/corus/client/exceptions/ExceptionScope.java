...
public enum ExceptionScope {
  ...
  UNDEFINED(100), MISC(102), CLI(104), CORE(110), CLUSTER_MANAGER(200), CRON_MODULE(300), DATABASE_MODULE(400), DEPLOYER(500), HTTP_MODULE(600), PORT_MANAGER(
      700), PROCESSOR(800), TASK_MANAGER(900);
