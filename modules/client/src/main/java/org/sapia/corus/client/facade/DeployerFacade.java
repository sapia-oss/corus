...
public interface DeployerFacade {
   ...
   * @throws DuplicateDistributionException if a distribution already exists that corresponds
   * to the given deployment.
   * @throws Exception if an undefined error occurs.
   */
  public ProgressQueue deployDistribution(String fileName, ClusterInfo cluster)
   ...
   * @param destinationDir the path to the directory where the file should be
   * uploaded (if <code>null</code>, the default upload directory on the remote
   ...
   * @throws Exception if an undefined error occurs.
   */
  public ProgressQueue deployFile(String fileName, String destinationDir, ClusterInfo cluster)
      throws java.io.IOException, 
      Exception;
  
  /**
   * Proceeds to the deployment of the script whose name and description are given.
   *
   * @param fileName the name of the script to deploy.
   * @param alias the alias of the script (acts as the script's identifier).
   * @param the script's description.
   * @param cluster a {@link ClusterInfo} instance.
   * @return a {@link ProgressQueue} instance.
   * @throws java.io.IOException if a IO error occurs.
   * @throws Exception if an undefined error occurs.
   */
  public ProgressQueue deployScript(String fileName, String alias, String description, ClusterInfo cluster)
      throws java.io.IOException, 
      Exception;
