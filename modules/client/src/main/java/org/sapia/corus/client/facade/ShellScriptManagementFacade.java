...
public interface ShellScriptManagementFacade {
  ...
  /**
   * @param criteria the criteria to use to select shell scripts to remove.
   ...
   * 
   * @param scriptAlias the alias of the script to execute.
   * @param cluster a {@link ClusterInfo} instance.
   * @return the {@link ProgressQueue} holding progress data.
   * @throws IOException if the script's execution could not be invoked.
   * @throws ScriptNotFoundException if no script could be found for the given alias.
   */
