...
/**
 * A class that performs the bulk of the deployment logic. Intended to be
 * inherited by classes that provide nitty-gritty connection details but will
 * share this class' deployment logic.
 * 
...
public abstract class AbstractDeploymentClient implements DeploymentClient {
  ...
  /**
   * Returns a stream that is used for deploying to the server to which this
   * instance is connected.
   * 
   * @param meta
   *          a {@link DeploymentMetadata} instance.
