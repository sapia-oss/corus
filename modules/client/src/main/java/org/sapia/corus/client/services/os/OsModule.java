...
public interface OsModule {
  ...
  /**
   * Executes the process specified by the given command-line and returns the corresponding PID.
   * 
   * @param log a {@link LogCallback}.
   * @param rootDirectory a {@link File} corresponding to the process' execution directory.
   * @param commandLine a {@link CmdLine} corresponding to the command-line to execute.
   * @return the native PID of the executed process.
   * @throws IOException if an error occurred while trying to execute the process.
   */
