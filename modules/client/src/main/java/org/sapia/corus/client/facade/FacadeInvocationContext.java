...
public class FacadeInvocationContext {
  ...
  /**
   * @param returnValue the {@link Object} corresponding to the return value of the last method invocation
   * on a facade.
   */
  ...
  /**
   * @return the {@link Object} corresponding to the return value of the last method invocation
   * on a facade.
   */
