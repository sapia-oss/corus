...
public class ObjectUtils {
  ...
  /**
   * Returns the given object's hash code, or 0 if the object is <code>null</code>.
   * 
  ...
  /**
   * Returns a hash code for all the given objects, even if some of them
   * are <code>null</code>.
   * 
   * @param objects one or many {@link Object}s.
   * @return a hash code resulting from the composition of all
   * the given objects' individual hash codes.
   */
