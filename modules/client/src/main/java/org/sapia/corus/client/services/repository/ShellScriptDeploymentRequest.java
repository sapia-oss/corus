...
/**
 * Sent to a Corus repository node so that deployment of the shell scripts that are specified
...
public class ShellScriptDeploymentRequest extends ArtifactDeploymentRequest {
   ...
   * @param files the {@link ShellScript} instances corresponding to the scripts that are requested.
   */
  ...
  /**
   * @return this instance's  unmodifiable {@link List} of {@link ShellScript} instances.
   */
