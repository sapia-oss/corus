...
/**
 * Models a delay. An instance is used to determine if a given time delay has
 * been reached.
 * <p>
 * Usage:
 * <p>
...
public class Delay {
  ...
  /**
   * Sets this instance's internal start time to
  ...
  /**
   * @return <code>true</code> if the time interval since this instance's start
   *         time is greater than or equal to this instance's duration.
   */
