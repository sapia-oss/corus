...
default['corus']['version'] = '5.0-RC1'
default['corus']['archive_download_url'] = 'http://www.mediafire.com/download/g4i33lmdnrhe4lv/sapia_corus_server_package-5.0-RC1-linux64.tar.gz'
