...
public class PortResourcesFuncTest {
  ...
  @Test
  public void testAddPortRange_partition() throws Exception {
    
    PartitionInfo partition = client.createPartitionSet();
    
    JSONValue response = client.resource("/clusters/ftest/" + partition + "/ports/ranges/test.port")
        .queryParam("min", "100")
        .queryParam("max", "105")
        .request()
          .header(FtestClient.HEADER_APP_ID, client.getAdminAppId())
  ...
  @Test
  public void testDeletePortRange_partition() throws Exception {
  ...
  @Test
  public void testReleasePortRange_partition() throws Exception {
  ...
  @Test
  public void testArchivePortRange_partition() throws Exception {
    
    PartitionInfo partition = client.createPartitionSet();
    
    client.getConnector().getPortManagementFacade().addPortRange("test.port", 100, 105, ClusterInfo.clustered());

    JSONValue response = client.resource("/clusters/ftest/" + partition + "/ports/ranges/archive")
        .queryParam("revId", "test")
        .request()
          .header(FtestClient.HEADER_APP_ID, client.getAdminAppId())
          .header(FtestClient.HEADER_APP_KEY, client.getAppkey())
    ...
    response = client.resource("/clusters/ftest/" + partition + "/ports/ranges/unarchive")
        .queryParam("revId", "test")
        .request()
          .header(FtestClient.HEADER_APP_ID, client.getAdminAppId())
          .header(FtestClient.HEADER_APP_KEY, client.getAppkey())
